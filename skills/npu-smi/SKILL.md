---
name: npu-smi
description: Complete reference for Huawei Ascend NPU npu-smi commands. Use when managing NPU devices, querying device status, configuring parameters, upgrading firmware, managing virtualization instances, or handling certificates.
---
...
- For common workflows, see [WORKFLOWS.md](WORKFLOWS.md)
